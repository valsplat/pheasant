...
class IdentityTest extends MysqlTestCase
{
    public function testEqualIdentities()
    {
        $animal1 = new Animal(['id' => 1, 'type' => 'llama']);
        $animal2 = new Animal(['id' => 1, 'type' => 'goat']);
